...
environment	production	2025-07-27 16:40:55.896898	2025-07-27 16:40:55.896898
\.
...
1	1	admin@example.net	t	t	2025-07-27 16:40:55.644681	2025-07-27 16:40:55.644681
2	5	alisonglasenapp@gmail.com	t	t	2025-07-27 16:43:14.694591	2025-07-27 16:43:14.694591
\.
...
1	Critical	1	f	IssuePriority	t	\N	\N	lowest
2	High	2	f	IssuePriority	t	\N	\N	default
3	Normal (default)	3	f	IssuePriority	t	\N	\N	high2
4	Low	4	f	IssuePriority	t	\N	\N	highest
\.
...
1	1	1	Add password reset feature to user accounts	Description:\r\n\r\nImplement a secure password reset functionality for user accounts.\r\n\r\nRequirements:\r\n\r\n    Create a "Forgot Password?" option on the login page\r\n\r\n    Send a password reset email with a unique, time-limited token\r\n\r\n    Build a frontend form to allow users to enter a new password\r\n\r\n    Validate the token and expiration before allowing the reset\r\n\r\n    Enforce password complexity rules\r\n\r\n    Return clear error messages for invalid or expired tokens\r\n\r\nTechnical Notes:\r\n\r\n    Store reset tokens with timestamps in a separate table (password_resets)\r\n\r\n    Expire tokens after 30 minutes\r\n\r\n    Use transactional email service (e.g. SendGrid or SMTP relay)\r\n\r\n    Log password reset attempts for audit purposes\r\n\r\nAcceptance Criteria:\r\n\r\n    User receives reset email within seconds\r\n\r\n    User can reset password using the emailed link\r\n\r\n    Expired or reused tokens are rejected\r\n\r\n    Password change is confirmed and old credentials no longer work	\N	\N	1	1	4	\N	1	2	2025-07-27 17:01:08.042534	2025-07-27 17:01:14.526986	2025-07-27	0	\N	\N	1	1	2	f	\N
2	2	1	Login page throws 500 error on empty email field	Description:\r\n\r\nA 500 Internal Server Error occurs when the email field is submitted empty on the login form.\r\n\r\nSteps to Reproduce:\r\n\r\n    Go to /login\r\n\r\n    Leave the email field empty\r\n\r\n    Enter any password\r\n\r\n    Click Login\r\n\r\nExpected Result:\r\n\r\n    The system should return a 422 Unprocessable Entity with a validation message like "Email is required."\r\n\r\nActual Result:\r\n\r\n    A 500 Internal Server Error is thrown, and the user sees a generic error page.\r\n\r\nTechnical Notes:\r\n\r\n    The controller does not properly validate null or empty email before processing\r\n\r\n    Likely uncaught exception on database lookup or email normalization	\N	\N	1	1	2	\N	1	1	2025-07-27 17:03:01.527272	2025-07-27 17:03:01.527272	2025-07-27	0	\N	\N	2	1	2	f	\N
3	1	1	Implement login route for user authentication	Subject: Implement login route for user authentication\r\n\r\nDescription:\r\n\r\nCreate a secure login route to authenticate registered users via email and password. The endpoint must validate input, check credentials, and return a JWT token for session handling.\r\n\r\nRequirements:\r\n- Endpoint: POST /api/login\r\n- Payload:\r\n  {\r\n    "email": "user@example.com",\r\n    "password": "plainTextPassword"\r\n  }\r\n\r\nBehavior:\r\n- Validate presence and format of `email` and `password`\r\n- Look up user by email\r\n- Check hashed password\r\n- If valid, return a JWT token with:\r\n  - user_id\r\n  - expires_in (e.g. 1 hour)\r\n- If invalid, return 401 Unauthorized with error message\r\n\r\nResponses:\r\n- 200 OK (Success):\r\n  {\r\n    "token": "JWT_TOKEN_STRING",\r\n    "expires_in": 3600\r\n  }\r\n\r\n- 401 Unauthorized (Invalid credentials):\r\n  {\r\n    "error": "Invalid email or password."\r\n  }\r\n\r\n- 422 Unprocessable Entity (Validation error):\r\n  {\r\n    "errors": {\r\n      "email": "Email is required.",\r\n      "password": "Password is required."\r\n    }\r\n  }\r\n\r\nSecurity Notes:\r\n- Use bcrypt or argon2 to hash and verify passwords\r\n- Implement JWT with a secure secret key and expiration time\r\n- Prevent brute-force attacks with rate-limiting or login throttling\r\n\r\nAcceptance Criteria:\r\n- User with valid credentials receives a JWT\r\n- Invalid credentials are rejected with a clear error\r\n- Password is never returned in any response\r\n- All logic is covered with unit and integration tests\r\n\r\nTech Stack Notes (optional):\r\n- Backend: PHP (Laravel) or Python (FastAPI)\r\n- Auth: JWT (e.g. firebase/php-jwt or pyjwt)\r\n- DB: PostgreSQL (users table)\r\n	\N	\N	2	1	3	\N	1	2	2025-07-27 17:05:38.608488	2025-07-27 17:10:27.807505	2025-07-27	0	\N	\N	3	1	2	f	2025-07-27 17:10:27.807505
4	1	1	Login button becomes unresponsive after incorrect password attempt	As a user, when I enter the wrong password on the login screen and try again, the "Login" button becomes unresponsive, forcing me to refresh the page to retry.\r\n\r\nThis creates friction in the authentication flow and may give the impression that the system is broken or offline.\r\n🔍 Steps to Reproduce:\r\n\r\n    Go to the login page\r\n\r\n    Enter a valid email and an incorrect password\r\n\r\n    Click Login\r\n\r\n    Try to enter the correct password and click Login again\r\n\r\n❌ Expected Behavior:\r\n\r\nThe user should be able to retry the login immediately after an invalid attempt — the form must remain fully functional.\r\n✅ Actual Behavior:\r\n\r\nThe Login button becomes disabled or unresponsive. No error message is shown after the second attempt.\r\n🎯 Business Impact:\r\n\r\nThis breaks the expected login experience and can increase user frustration, especially on mobile. We've already received reports from customer support about this behavior.\r\n🧪 Suggested Test Case:\r\n\r\n    Simulate wrong credentials → ensure user can retry login without refreshing\r\n\r\n    Verify proper reactivation of the button and visibility of error messages	\N	\N	1	1	2	\N	1	1	2025-07-27 22:43:17.363837	2025-07-27 22:43:17.363837	2025-07-27	0	\N	\N	4	1	2	f	\N
5	1	1	Allow users to update their profile information	As a registered user, I want to be able to update my personal information (name, email, and profile picture) so that my account stays up to date and reflects my current identity.\r\n\r\nThis is a core part of user autonomy and improves trust in the platform by giving users direct control over their data.\r\n🧩 Requirements:\r\n\r\n    Add “Edit Profile” option under the user account dropdown\r\n\r\n    Editable fields:\r\n\r\n        Full name\r\n\r\n        Email address\r\n\r\n        Profile picture (optional upload)\r\n\r\n    Validations:\r\n\r\n        Email must be unique and valid\r\n\r\n        Name cannot be empty\r\n\r\n    Show success message after saving\r\n\r\n    Prevent reusing an email already in use\r\n\r\n🔐 Security Notes:\r\n\r\n    Only allow the user to update their own profile\r\n\r\n    Profile picture uploads must be restricted to JPG/PNG and validated on size/format\r\n\r\n    Email change should require re-authentication (optional for now)\r\n\r\n✅ Acceptance Criteria:\r\n\r\n    User can access the edit profile page from the UI\r\n\r\n    Valid updates are saved and reflected immediately\r\n\r\n    Invalid inputs return clear messages\r\n\r\n    Avatar update works as expected\r\n\r\n    Profile remains secure — no unauthorized access to others' data	\N	\N	1	1	3	\N	1	1	2025-07-27 22:43:58.45788	2025-07-27 22:43:58.45788	2025-07-27	0	\N	\N	5	1	2	f	\N
\.
...
1	1	Issue	1		2025-07-27 17:01:14.534446	f	2025-07-27 17:01:14.534446	\N
2	3	Issue	1	Concluded	2025-07-27 17:10:27.810816	f	2025-07-27 17:10:27.810816	\N
\.
...
2	1	1	2025-07-27 16:52:31.086513	f
\.
...
1	Dev Team	This project is dedicated to managing and tracking all activities related to the software development department. It includes tasks such as feature implementation, bug fixing, code refactoring, system integrations, and performance improvements. The goal is to ensure high-quality deliverables through collaboration, version control, and continuous improvement practices. All development-related issues and milestones should be registered and followed here.		t	\N	2025-07-27 16:45:56.384223	2025-07-27 16:52:37.226833	dev-team	1	1	2	f	\N	1	\N
\.
...
1	text_formatting	common_mark	\N
2	rest_api_enabled	1	2025-07-27 18:17:00.134363
3	jsonp_enabled	0	2025-07-27 18:17:00.142452
\.
...
3	1	feeds	26273ead2ffc89d1b97043da84ee09f97f58face	2025-07-27 16:43:49.731451	2025-07-27 16:43:49.731451
6	1	api	fc4a0ab3c1fe6c34ee12a2f25e70bc436f3e4e39	2025-07-27 18:17:25.016575	2025-07-27 18:17:25.016575
9	1	session	ebf44bed53604f766feddb5eb249dbb595cb946a	2025-07-27 22:42:03.068796	2025-07-27 22:46:42.043263
\.
...
1	Feature	1	t	0	1	Represents a new functionality or enhancement to be implemented in the system.
2	Bug	2	t	0	1	
\.
...
2				Anonymous users	f	1	\N		\N	2025-07-27 16:40:55.602723	2025-07-27 16:40:55.602723	GroupAnonymous		\N	f	\N	\N	\N	\N	f
3				Non member users	f	1	\N		\N	2025-07-27 16:40:55.618128	2025-07-27 16:40:55.618128	GroupNonMember		\N	f	\N	\N	\N	\N	f
4				Anonymous	f	0	\N		\N	2025-07-27 16:41:13.98805	2025-07-27 16:41:13.98805	AnonymousUser	only_my_events	\N	f	\N	\N	\N	\N	f
5	Glasena	f640fbd9021f990f6c99c270fe7ca0d5fe9591ed	Alison	Glasenapp	f	2	\N	en	\N	2025-07-27 16:43:14.689472	2025-07-27 16:43:14.689472	User	only_my_events	30e1f5e7cff59d1901535218835b95bb	f	2025-07-27 16:43:14	\N	\N	\N	f
1	admin	856f9bf72e6b98309cb5a2544f9f2c5878cd4990	Redmine	Admin	t	1	2025-07-27 22:42:03.048001		\N	2025-07-27 16:40:53.998633	2025-07-27 22:41:54.841354	User	all	9b8399ae8e268704e7a9e4e3505d86a6	f	2025-07-27 22:41:54	\N	\N	\N	f
\.
...
1	1	0	1	3	f	f	WorkflowTransition	\N	\N
3	1	1	2	3	f	f	WorkflowTransition	\N	\N
\.
...
SELECT pg_catalog.setval('public.issues_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.watchers_id_seq', 5, true);
